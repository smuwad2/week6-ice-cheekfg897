...
<template>
    ...
    <div class="container">
        <div class="form-section">
            ...
            <button class="theme-button" v-on:click="colorChange()">Cycle theme</button> <!-- click button to cycle through the themes -->
        ...
        <div class="preview-section">
            ...
            <div class="preview-card"
                :style="{ backgroundColor: bgColor, color: textColor}"> <!-- Add code here to set background color and text color -->
